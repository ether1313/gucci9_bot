...
1. **GET FREE SPIN ON GUCCI9 🎰** - Shows free spin promotional information with inline buttons:
...
- `TELEGRAM_CHANNEL` (Optional) - Telegram channel URL (default: `https://t.me/gucci9`)
- `FREE_SPIN_URL` (Optional) - Free spin promotion URL (default: `https://gucci9.com/RFGUCCI9BOT9`)
- `FREE_CREDIT_URL` (Optional) - Free credit promotion URL (default: `https://gucci9.com/RFGUCCI9BOT9`)
...
```bash
docker build -t gucci9-bot .
docker run -d --env-file .env gucci9-bot
```
...
2. Create volume: `fly volumes create gucci9_bot_data --size 1 --region sin`
...
**Gucci9 Promo Bot** - Making marketing simpler! 🚀
